...
SelectVO = function(keys)
	...
	if keys.num >= startheronums then
		...
		if keys.num < (startheronums-8) then
			local mesarrs = {
				...
				"321_lets_go",
				"did_we_actually_win",
				"every_game_like_the_last",
				"ive_won_the_international",
				"keyboard_not_working",
				"moolah",
				"no_more_tips",
				--truesight2
				"snail_walks_into_a_bar",
				"sounds_good",
	...
	if selectedstr ~= nil and selectedid2 ~= nil then
		local heroesvo = {
			{
				...
				"soundboard.no_chill",
				"soundboard.ding_ding_ding",
				"soundboard.absolutely_perfect",
				"soundboard.lets_play",
				--ch an
				...
				--meme
				"Voice_Thdots_Yugi.AbilityYugi04_1",
				"Voice_Thdots_Yugi.AbilityYugi04_2",
				"ChatWheel.Ayaya",
				"",
				"",
				"",
				...
				"soundboard.ti10_truesight.every_game_like_the_last",
				"soundboard.ti10_truesight.ive_won_the_international",
				"soundboard.ti10_truesight.keyboard_not_working",
				"soundboard.ti10_truesight.moolah",
				"soundboard.ti10_truesight.no_more_tips",
				--truesight2
				"soundboard.ti10_truesight.snail_walks_into_a_bar",
				"soundboard.ti10_truesight.sounds_good",
		...
		if votimer[keys.PlayerID] ~= nil then
			if Time() - votimer[keys.PlayerID] > chat_cooldown then
