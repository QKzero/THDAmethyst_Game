...
function ability_thdots_parsee03:OnSpellStart()
	...
	for i = 1,number do
		...
		SetTHD2BlockingNeutrals(parsee03_eyes, false)
...
function modifier_ability_thdots_parsee03_dummy:GetAbsoluteNoDamagePhysical() return 1 end
function modifier_ability_thdots_parsee03_dummy:GetAbsoluteNoDamageMagical() return 1 end
function modifier_ability_thdots_parsee03_dummy:GetAbsoluteNoDamagePure() return 1 end
...
function modifier_ability_thdots_parsee03_dummy:OnIntervalThink()
	if not IsServer() then return end
	local dummy = self:GetParent()
	local damage_perFrameTime = dummy:GetBaseMaxHealth() / self.duration * 0.05
...
function modifier_ability_thdots_parsee04_dummy:OnIntervalThink()
	...
	ParticleManager:SetParticleControl(parsee04_particle_4, 1, Vector(self.relive_range,0.3,self.relive_range))
