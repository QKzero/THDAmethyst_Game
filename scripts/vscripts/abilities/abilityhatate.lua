...
function ability_thdots_hatate01:OnSpellStart()
	...
	if FindTelentValue(caster,"special_bonus_unique_hatate_3") == 1 then
		...
		illusion:AddNewModifier(caster, self, "modifier_ability_thdots_hatate01_illusion", {Duration = illusions_duration})
	end
...
LinkLuaModifier("modifier_ability_thdots_hatate01", "scripts/vscripts/abilities/abilityhatate.lua", LUA_MODIFIER_MOTION_NONE)

function modifier_ability_thdots_hatate01:IsHidden() 		return true end
function modifier_ability_thdots_hatate01:IsPurgable()		return false end
function modifier_ability_thdots_hatate01:RemoveOnDeath() 	return false end
function modifier_ability_thdots_hatate01:IsDebuff()		return false end
...
LinkLuaModifier("modifier_ability_thdots_hatate01_illusion", "scripts/vscripts/abilities/abilityhatate.lua", LUA_MODIFIER_MOTION_NONE)

function modifier_ability_thdots_hatate01_illusion:IsHidden() 		return true end
function modifier_ability_thdots_hatate01_illusion:IsPurgable()		return false end
function modifier_ability_thdots_hatate01_illusion:RemoveOnDeath() 	return true end
function modifier_ability_thdots_hatate01_illusion:IsDebuff()		return false end
