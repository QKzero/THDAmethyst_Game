...
function OnNue04PhaseStart(keys)
	local caster = EntIndexToHScript(keys.caster_entindex)
	keys.ability.ufoIndex = ParticleManager:CreateParticle("particles/heroes/nue/ability_nue_04_light_ufo.vpcf", PATTACH_CUSTOMORIGIN, nil)
...
function OnNue04Start(keys)
	...
	local ufoMoveIndex = ParticleManager:CreateParticle("particles/heroes/nue/ability_nue_04_warning_circle.vpcf", PATTACH_CUSTOMORIGIN, nil)
